...
public class JdbcTacoRepository implements TacoRepository {
	...
	private long saveTacoInfo(Taco taco) {
		...
		PreparedStatementCreator psc = getTacoPreparedStatementCreater(taco);
	...
	private PreparedStatementCreator getTacoPreparedStatementCreater(Taco taco) {
		...
		return factory.newPreparedStatementCreator(
